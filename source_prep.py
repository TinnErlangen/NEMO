...
sub_dict = {"NEM_19":"ALC81","NEM_20":"PAG48",
           ...
           "NEM_37":"EAM67"}
# sub_dict = {"NEM_10":"GIZ04","NEM_11":"WOO07","NEM_12":"TGH11","NEM_14":"FIN23","NEM_15":"KIL13","NEM_16":"KIO12","NEM_17":"DEN59","NEM_18":"SAG13","NEM_24":"BII41"}
...
for meg,mri in sub_dict.items():
    ...
    fwd_rest = mne.make_forward_solution(rest.info, trans=trans, src=src, bem=bem,meg=True, mindist=1.0, n_jobs=8)
